...
class FilterViewAdapter(private val mFilterListener: FilterListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.filters_row, parent, false)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val mImageFilterView: ImageView = itemView.findViewById(R.id.imageViewFilterImage)
        val mTxtFilterName: TextView = itemView.findViewById(R.id.textViewFilterName)
